...
import jp.kopher.springsecurityinaction.repositories.UserRepository
...
class JpaUserDetailsService(
    ...
    override fun loadUserByUsername(username: String?): UserDetails {
        ...
        val user = userRepository.findUserByUsername(username) ?: throw UsernameNotFoundException("User not found")
